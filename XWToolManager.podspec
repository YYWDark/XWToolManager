#
#  Be sure to run `pod spec lint XWToolManager.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/YYWDark/XWToolManager.git"
  ...
  #s.source       = { :git => "https://github.com/YYWDark/XWToolManager.git" }
  #这里不支持ssh的地址，只支持HTTP和HTTPS，最好使用HTTPS
  #正常情况下我们会使用稳定的tag版本来访问，如果是在开发测试的时候，不需要发布release版本，直接指向git地址使用
  #待测试通过完成后我们再发布指定release版本，使用如下方式
  #s.source       = { :git => "https://github.com/YYWDark/XWToolManager.git", :tag => 0.0.1 }
  s.source   = { :git => 'https://github.com/YYWDark/XWToolManager.git', :tag => s.version}
